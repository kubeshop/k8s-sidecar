# Taken from https://github.com/kubernetes-client/python/blob/master/kubernetes/base/config/incluster_config.py
...
def load_incluster_config(client_configuration=None, try_refresh_token=True, sa_credentials_path_prefix=None):
    """
    ...
    InClusterConfigLoader(
        token_filename=sa_credentials_path_prefix + "/token",
        cert_filename=sa_credentials_path_prefix + "/ca.crt",
